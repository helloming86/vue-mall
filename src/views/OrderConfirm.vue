    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <textarea name="street" v-model="checkedItem.receiverAddress" />
          </div>
          <div class="item">
  ...
  methods: {
    ...
    getCartList () {
      this.axios.get('/carts').then((res) => {
        let list = res.cartProductVoList // 获取购物车所有商品的数据
